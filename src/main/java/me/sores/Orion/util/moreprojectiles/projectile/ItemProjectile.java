package me.sores.Orion.util.moreprojectiles.projectile;

import me.sores.Orion.Orion;
import me.sores.Orion.util.moreprojectiles.TypedRunnable;
import me.sores.Orion.util.moreprojectiles.event.CustomProjectileHitEvent;
...
public class ItemProjectile extends EntityItem implements IProjectile, CustomProjectile<ItemProjectile> {
    ...
    public static FixedMetadataValue meta = new FixedMetadataValue(Orion.getInstance(), true);
